...
//        if (viewHolder is ItemTouchViewHolder) viewHolder.onItemCleared()
    ...
    private fun drawIcon(canvas: Canvas, itemView: View, dX: Float) {
        ...
        with(iconBounds) {
            left = itemView.right.toInt() + dX.toInt() + space
            top = itemView.top.toInt() + margin
            right = itemView.right.toInt() + dX.toInt() + space + iconSize
            bottom = itemView.bottom.toInt() - margin
        }
